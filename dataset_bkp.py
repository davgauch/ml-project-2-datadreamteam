...
class WebcamDataset(Dataset):
    ...
    def __init__(self, images_path_bc, images_path_m, ghi_values_path, transform=None, subset=None, normalize_labels=True, meteo_file_path=None, meteo_features=None):
        """
